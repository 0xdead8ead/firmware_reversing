...
function CreateDir()
{
	...
	for(var i=0;i<dir_names.length;i++)
	{
		...
		{
			alert("Can't create directory. Already exists.");
			return;
		}
	}
	//---
...
<DIV id="mainDIV"><!--style="padding:0px; width:99%; position: absolute; left:0px; top:0px; z-index:2" >-->
	<!--
	<H2>Connect : <input id="link_text" type=text size=40 maxlength=100 readonly>  <input type=button value="Save" onclick="SaveLinkDir();"></H2>
	-->
