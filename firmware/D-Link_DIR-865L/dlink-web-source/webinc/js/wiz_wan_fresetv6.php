...
Page.prototype =
{
	...
	IsDirty: function() 
	{
		if(document.getElementsByName("wiz_pppoe_sess_type")[0].checked) return true; 
		else return this.Dirty;
	},
	...
	OnChangePPPoESessType: function()
	{
		...
		{
			OBJ("wiz_pppoe_usr").disabled = true;
			OBJ("wiz_pppoe_passwd").disabled = true;
			OBJ("wiz_pppoe_passwd2").disabled = true;
			OBJ("wiz_pppoe_svc").disabled = true;
			this.LoadPpp4Value();
		}
		else
		{
			OBJ("wiz_pppoe_usr").disabled = false;
			OBJ("wiz_pppoe_passwd").disabled = false;
			OBJ("wiz_pppoe_passwd2").disabled = false;
			OBJ("wiz_pppoe_svc").disabled = false;
		}
	...
	LoadPpp4Value: function()
	{
	  ...
	  OBJ("wiz_pppoe_passwd").value	= XG(this.inet1p+"/ppp4/password");
		OBJ("wiz_pppoe_passwd2").value	= OBJ("wiz_pppoe_passwd").value;
		OBJ("wiz_pppoe_svc").value	= XG(this.inet1p+"/ppp/pppoe/servicename");
	},
