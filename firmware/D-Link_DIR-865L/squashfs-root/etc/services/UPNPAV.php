...
else
{
	...
	{														
		...
		fwrite("a", $START, "upnp 0 \"".$vendor." Corporation\" \"".$product_url."\" \"Network File Server with USB2.0 and wifi interface\" ". "\"".$Genericname."\" \"".$product_url."\" \"".$model_number."\" \"".$mac_addr."\" \"".$dms_name."\" \"".$version."\" &\n");
