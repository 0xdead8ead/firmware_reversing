...
if(get_phyinf_sta_mode($PHY_UID) == 1)
{
...
//if($prefix == "BAND24G")
if($PHY_UID=="BAND24G-1.1")
{
	$upwifistats_pidfile = "/var/run/upwifistats24g.pid";
	$helper_script 		 = "/etc/scripts/upwifistatshlper_G_band.sh";
}
else if($PHY_UID=="BAND24G-1.2")
{
	$upwifistats_pidfile = "/var/run/upwifistats24g-2.pid";
	$helper_script       = "/etc/scripts/upwifistatshlper_G_band.sh";
}
else if($PHY_UID=="BAND5G-1.1")
{
	$upwifistats_pidfile = "/var/run/upwifistats5g.pid";
	$helper_script       = "/etc/scripts/upwifistatshlper_A_band.sh";
}
...
{ 
	$upwifistats_pidfile = "/var/run/upwifistats5g-2.pid";
	$helper_script 		 = "/etc/scripts/upwifistatshlper_A_band.sh";
}
