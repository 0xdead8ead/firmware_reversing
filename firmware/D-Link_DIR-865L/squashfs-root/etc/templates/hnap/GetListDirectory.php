...
$result = "OK";
$request_path = get("s","/runtime/hnap/GetListDirectory/ListDirectoryPath");
		...
		else
		{
			...
			while($i < $cut_count)
			{
				...
				*/			
				...
				$check_subdir = get("s","/runtime/hnap/GetListDirectory/check_subdir");
				...
				echo "<ListDirectoryInfo>";
				echo "<DirectoryName>".$DirectoryName."</DirectoryName>";
				echo "<DirectoryPath>".$DirectoryPath."</DirectoryPath>";
				echo "<SubDirectory>".$SubDirectory."</SubDirectory>";		
				echo "</ListDirectoryInfo>";
