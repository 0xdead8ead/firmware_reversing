...
<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"><soap:Body><GetWLanRadioSecurityResponse xmlns="http://purenetworks.com/HNAP1/"><GetWLanRadioSecurityResult><?=$result?></GetWLanRadioSecurityResult><Enabled><?=$enabled?></Enabled><Type><?=$type?></Type><Encryption><?=$encrypt?></Encryption><KeyRenewal><?=$keyRenewal?></KeyRenewal><Key><?=$key?></Key><RadiusIP1><?=$radiusIP1?></RadiusIP1><RadiusPort1><?=$radiusPort1?></RadiusPort1><RadiusSecret1><?=$radiusSecret1?></RadiusSecret1><RadiusIP2><?=$radiusIP2?></RadiusIP2><RadiusPort2><?=$radiusPort2?></RadiusPort2><RadiusSecret2><?=$radiusSecret2?></RadiusSecret2></GetWLanRadioSecurityResponse></soap:Body></soap:Envelope>
