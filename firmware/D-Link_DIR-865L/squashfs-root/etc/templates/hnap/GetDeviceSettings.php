...
<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body>
	...
	if (query("/device/layout")=="router") { echo "GatewayWithWiFi"; } else { echo "WiFiAccessPoint"; }
      ?></Type>
      <DeviceName><? echo get("x","/sys/devicename");?></DeviceName><VendorName><? echo query("/runtime/device/vendor");?></VendorName>
      ...
      <SOAPActions>
	        ...
	        <string>http://purenetworks.com/HNAP1/IsDeviceReady</string>
					...
					<string>http://purenetworks.com/HNAP1/SetStorageUsers</string>
					<string>http://purenetworks.com/HNAP1/GetUSBStorageSettings</string>
					<string>http://purenetworks.com/HNAP1/SetUSBStorageSettings</string>
					<string>http://purenetworks.com/HNAP1/GetClientInfo</string>
					<string>http://purenetworks.com/HNAP1/GetListDirectory</string>
					<string>http://purenetworks.com/HNAP1/DoFirmwareUpgrade</string>
					<string>http://purenetworks.com/HNAP1/GetEthernetPortSetting</string>
      </SOAPActions>
      <SubDeviceURLs>
      </SubDeviceURLs>
      <Tasks>
