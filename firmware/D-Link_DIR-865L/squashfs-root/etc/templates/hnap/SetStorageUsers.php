...
foreach("/runtime/hnap/SetStorageUsers/StorageUserInfoLists/StorageUser")
{
	...
	TRACE_debug("SetStorageUsers get UserName: " . $req_UserName);
	TRACE_debug("SetStorageUsers get Password: " . $req_Password);
	TRACE_debug("SetStorageUsers get AccessPath: " . $req_AccessPath);
	TRACE_debug("SetStorageUsers get Permission: " . $req_Promission);
