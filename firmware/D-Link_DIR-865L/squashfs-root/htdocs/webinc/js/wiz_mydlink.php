...
Page.prototype =
{
	...
	CheckPassword: function()
	{
		...
		if(password_blank)
		{
			if(confirm('<?echo I18N("h", "The Admin password could be blank to set the mydlink registration. Would you want to change the Admin password?");?>')) self.location.href="tools_admin.php";
