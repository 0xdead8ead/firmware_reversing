...
Page.prototype =
{
	...
	PreSubmit: function()
	{
		...
		for (var i=1; i<cur_count; i+=1)
		{
			...
			{
				if(OBJ("ip_"+i).value!="" && OBJ("ip_"+j).value!="" && OBJ("port_tcp_"+i).value!="" && OBJ("port_tcp_"+j).value!="" &&
					OBJ("port_udp_"+i).value!="" && OBJ("port_udp_"+j).value!="" && OBJ("sch_"+i).value!="" && OBJ("sch_"+j).value!="" &&
					OBJ("dsc_"+i).value != "" && OBJ("dsc_"+j).value !="") 
				{					
					if(OBJ("ip_"+i).value===OBJ("ip_"+j).value && OBJ("port_tcp_"+i).value===OBJ("port_tcp_"+j).value &&
						OBJ("port_udp_"+i).value===OBJ("port_udp_"+j).value && OBJ("sch_"+i).value===OBJ("sch_"+j).value) 
					{
