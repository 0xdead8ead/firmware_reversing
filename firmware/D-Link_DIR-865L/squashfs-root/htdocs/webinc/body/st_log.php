...
<div class="blackbox">
	...
	<tr>
		...
		<td align="left"><input type="radio" id="attack" name="Type" onclick='PAGE.OnClickChangeType("attack");' modified="ignore" <? if(query("/device/layout")=="bridge") echo "disabled";?>><?echo i18n("Firewall &amp; Security");?></td>
		<td align="left"><input type="radio" id="drop" name="Type" onclick='PAGE.OnClickChangeType("drop");' modified="ignore" <? if(query("/device/layout")=="bridge") echo "disabled";?>><?echo i18n("Router Status");?></td>
	</tr>
	<tr>
		<td colspan="2"></td>
	</tr>
