...
<div class="blackbox" id="tools_email">
	...
	<p><?echo i18n("The Email feature can be used to send the system log files, router alert messages, and firmware update notification to your email address.");?></p>
	<dl>
		<dt><?echo i18n("Enable");?>
		<dd><dl>
			<dt><?echo i18n("Enable Email Notification");?></dt>
			<dd><?
				echo i18n("When this option is enabled, router activity logs or firmware upgrade notifications can be emailed to a designated email address, and the following parameters are displayed.");
			?></dd>
		</dl></dd></dt>
		...
		<dd><dl>
			...
			<dd><?
				echo i18n("This email address will appear as the sender when you receive a log file or firmware upgrade notification via email.");
			?></dd>
