...
/* this can be used when region is China and Middle Eeast(Iran/Lebanon/Qatar)*/
	...
	if(dfs_channel2_router_flag == 1)//bug 25665:DFS channel should be supported in Canada, Europe and Austrilia
	{
			...
			else if( index == Canada )
			{
				...
				{
					channel.options.length = 16; //36101 show single channel //bug 41674
					...
					channel.options[10].value =  108;
					channel.options[10].text = "108(DFS)";
					channel.options[11].value =  112;
					channel.options[11].text = "112(DFS)";
					channel.options[12].value = channel.options[12].text =  149;
					channel.options[13].value = channel.options[13].text =  153;
					channel.options[14].value = channel.options[14].text =  157;
					channel.options[15].value = channel.options[15].text =  161;
				}
			}
			/*else if(index == Canada )
			{				
