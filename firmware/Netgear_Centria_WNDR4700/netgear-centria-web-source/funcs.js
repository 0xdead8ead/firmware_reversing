...
function show_hidden_help_green(help_flag)
{
	...
	else
	{
		...
		if( help_flag % 2 == 0 )
		{
			document.getElementById("main").style.height=frame_height-150;//30+120
			document.getElementById("help").style.display="";
			document.getElementById("help_switch").className="open_help";
		}
		else
		{
			document.getElementById("help").style.display="none";
			document.getElementById("help_switch").className="close_help";
			document.getElementById("main").style.height=frame_height-30;//20+30
		}
	}
}
...
function getkey(type, e)
{
	...
	{//bug 38613
		if (((keycode>47) && (keycode<58))||(keycode==45)||(keycode==46)||((keycode>64) && (keycode<91)) || (keycode==95) || ((keycode>96) && (keycode<123)) || (keycode==8)||(keycode==0)) { return true; }
		else return false;
	}
	else if(type == "mac")
	{
...
{// 0-9, a-z, A-Z, -, _, .
	if (!(((each_char>47) && (each_char<58))||(each_char==45)|| (each_char==95) || (each_char==46)||((each_char>64) && (each_char<91))||((each_char>96) && (each_char<123)) || (each_char==8)||(each_char==0))) 
		return false;
}
